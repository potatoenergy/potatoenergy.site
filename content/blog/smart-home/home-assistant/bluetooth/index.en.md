...
> 💡 **Purpose**: passive scanning doesn't send active requests, saving device battery. This feature in BlueZ is marked "experimental".

---

## 🔗 Pairing Devices (On Host)

Bluetooth management is performed **only on the host**, not inside the container.
...
> ✅ After pairing on host, Home Assistant sees the device via passthrough D-Bus.
