...
Inaccurate coordinates cause false triggers, wrong forecasts, and broken automations.

---

## 🎯 Limitations of the Default Wizard

During initial setup, Home Assistant asks to pick a location on a map. However:
