...
Sometimes an app on NixOS is only available for Ubuntu/Debian or ships as `.deb`/`.iso`. Distrobox lets you run it in a container with host integration - like a native app.
...
App becomes available in menu, launchers, and search.
