...
aliases:
  - /blog/linux/nix/distrobox-apps/
---

Иногда на NixOS требуется запустить программу, которая доступна только для Ubuntu/Debian или распространяется в виде `.deb`/`.iso`. Distrobox позволяет запустить её в контейнере с интеграцией в систему хоста - как нативное приложение.
...
Приложение станет доступно в меню, лаунчерах и поиске.
...
> ⚠️ Удаление volumes необратимо - убедиться, что внутри нет нужных данных.
