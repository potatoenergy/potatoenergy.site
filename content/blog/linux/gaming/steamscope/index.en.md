...
Running games via Steam on Linux requires different flags for different engines, various environment variables for AMD and NVIDIA, and manual insertion of tools like Gamescope and MangoHud into the launch command.
