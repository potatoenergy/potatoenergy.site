...
aliases:
  - /blog/linux/ventoy-multiboot/
---

Вместо форматирования флешки под каждый новый образ **Ventoy** позволяет копировать ISO-файлы как обычные файлы. При загрузке появляется меню со всеми доступными образами.
...
3. **Своя тема** - создать по документации Ventoy
