...
Instead of reformatting the USB for each new image, **Ventoy** allows copying ISO files as regular files. At boot, a menu appears with all available images.
...
/ventoy/
└── revi/
    └── autounattend.xml     # Windows Setup answers
