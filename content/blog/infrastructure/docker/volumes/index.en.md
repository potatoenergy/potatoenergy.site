...
Docker Volumes store data independently from containers but require a separate approach for backup. This guide describes universal methods for working with volumes using popular services as examples.

> 💡 Replace volume names in examples with your own. Methods apply to any containers.
...
**Reasons for using temporary containers**:
