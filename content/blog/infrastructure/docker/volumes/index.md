...
aliases:
  - /blog/docker/volumes-management/
---
...
> 💡 Имена volumes в примерах следует заменить на свои. Методы применимы к любым контейнерам.
...
- Очистка от временных файлов (копирование только нужного)
