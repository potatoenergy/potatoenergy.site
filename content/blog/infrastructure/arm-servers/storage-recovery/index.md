...
aliases:
  - /blog/linux/orangepi/storage-recovery/
---
...
### Проверка занятого места по директориям
...
**Обоснование использования `du -h`**:

- `-h` - человекочитаемый формат (K, M, G)
- Показывает реальное занятое место на диске, а не размер файлов
...
**Обоснование использования rsync вместо cp**:
