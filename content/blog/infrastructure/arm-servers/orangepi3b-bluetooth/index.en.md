...
# ← Process completes in 2-3 seconds if chip responded
...
If running Home Assistant or another app in Docker:
...
> ⚠️ **Don't use `network_mode: host` just for Bluetooth** - it breaks network isolation. Mounting `/run/dbus` is sufficient.
